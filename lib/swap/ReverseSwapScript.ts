...
import { script, crypto } from 'liquidjs-lib';
 ...
 */
const reverseSwapScript = (preimageHash: Buffer, claimPublicKey: Buffer, refundPublicKey: Buffer, timeoutBlockHeight: number): Buffer => {
